...
public class ArmElevatorToSetpointAuto extends ParallelDeadlineGroup {
    public ArmElevatorToSetpointAuto(ElevatorSubsystem elevator, ArmSubsystem arm, double elevatorSetpoint, double armSetpoint) {
